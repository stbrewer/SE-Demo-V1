...
EC2 Instances: terraform apply -target"aws_instance.AWS_Prod_Instance_1" -target="aws_instance.AWS_Dev_Instance_1" -target="aws_instance.AWS_QA_Instance_1"
...
FireNet: terraform apply -target="aviatrix_firenet.Azure_Firenet" -target="aviatrix_firewall_instance.Azure_Firewall_Instance" -target="aviatrix_firewall_instance_association.firewall_instance_association_2" -var-file="Variables.tfvars"
